const { DATABASE } = require("./black_hat/database/database");
  ...
  async function getSetting(key) {
      ...
      return record ? record.value : (DEFAULT_SETTINGS[key] || null);
  }
  ...
  async function setSetting(key, value) {
      ...
      if (!created) { record.value = value; await record.save(); }
      return true;
  }
  ...
  async function resetSetting(key) {
      ...
      if (defaultValue !== undefined) { await setSetting(key, defaultValue); return defaultValue; }
      return null;
  }
  ...
  module.exports = {
      SettingsDB, DEFAULT_SETTINGS, initializeSettings,
      getSetting, setSetting, getAllSettings, resetSetting, resetAllSettings,
  };
